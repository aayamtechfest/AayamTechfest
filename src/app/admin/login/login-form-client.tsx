    ...
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[#0f0f23]">
      ...
      <div className="relative z-10 w-full max-w-md px-4">
        ...
        <div className="mb-8 text-center flex flex-col items-center">
          ...
          <h1 className="bg-gradient-to-r from-white via-indigo-200 to-indigo-400 bg-clip-text text-5xl font-extrabold tracking-tight text-transparent">
            AAYAM
          </h1>
        ...
        <p className="mt-6 text-center text-xs text-gray-500">
          Secured admin access &bull; AAYAM Event Platform
        </p>
      </div>
    </div>
  );
